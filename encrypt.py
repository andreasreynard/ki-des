...
i = 0
while i != 16:
    message = input('Plaintext block: 0x')
    i = len(message)
...
for j in range(16):
    ...
    kxore = ''
    for o in range(1,49):
        kxore = kxore + str(int(k[j+1][o]) ^ int(e[o]))
...
for z in range(lead_zeros):
    ciptxt = '0' + ciptxt
print('Ciphertext block: 0x' + ciptxt)
print('The ciphertext is ' + ciptxt + '.')